    ...
    <div class="col-md-8">
        <div class="card shadow">
            <div class="card-body table-responsive">
                <table class="table table-bordered table-hover" style="border-collapse: collapse; border-spacing: 0; width: 100%;" id="tabel_manfaat" width="100%" cellspacing="0">
                    <thead class="thead-light text-center">
                        <tr>
                            ...
                            <th width="10%">Nilai Pertanggungan</th>
                ...
                <div class="card-body d-flex justify-content-center">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label for="lob" class="col-form-label text-left">Manfaat<span class="text-danger">*</span></label>
                            <div class="">
                                <textarea name="manfaat" id="manfaat" rows="5" class="form-control" placeholder="Masukkan Manfaat" required data-parsley-required-message="Manfaat harus terisi."></textarea>
                            </div>
                        </div> 
                        <div class="form-group form2">
                            <label for="nilai" class="col-form-label text-left">Nilai Pertanggungan<span class="text-danger">*</span></label>
                            <div class="input-group">
                                <div class="input-group-append">
                                    <span class="input-group-text" id="basic-addon2">Rp.</span>
                                </div>
                                <input type="text" class="form-control text-right numeric number_separator" id="nilai" name="nilai" placeholder="Masukkan Nilai" required data-parsley-required-message="Nilai harus terisi.">
                            </div>
                        </div>  
                        <div class="form-group">
                            <label for="keterangan" class="col-form-label text-left">Keterangan<span class="text-danger">*</span></label>
                            <div class="">
                                <textarea name="keterangan" id="keterangan" rows="5" class="form-control" placeholder="Masukkan Keterangan" required data-parsley-required-message="Keterangan harus terisi."></textarea>
                            </div>
                        </div> 
                        ...
                        <div class="form-group text-center mt-1 mb-0">
                            ...
                            <button type="button" class="btn btn-danger mt-1 batal_manfaat" id="batal_manfaat"><i class="fas fa-times mr-1"></i> Batal</button>
                        </div>   
...
<script>
    ...
    $(document).ready(function () {
        ...
        var tabel_list_manfaat = $('#tabel_manfaat').DataTable({
            "processing"        : true,
            "serverSide"        : true,
            "order"             : [],
            "ajax"              : {
                "url"   : "<?= base_url() ?>Manfaat/tampil_data_manfaat",
                "type"  : "POST",
                "data"  : function (data) {
                    data.read               = "<?= $role['read'] ?>";
        ...
        function tampil_premi() {
            ...
            $.ajax({
                url         : "<?= base_url() ?>Manfaat/tampil_premi",
                method      : "POST",
        ...
        $('#batal_manfaat').on('click', function () {
            reset_form();
        })
        ...
        $('#form_manfaat').on('submit', function () {
            ...
            var form_manfaat = $('#form_manfaat').serialize();
            ...
            swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            url     : "<?= base_url() ?>Manfaat/simpan_manfaat",
                            type    : "POST",
                            beforeSend  : function () {
                                swal({
                                    title   : 'Menunggu',
                            ...
                            success : function (data) {
                                ...
                                tabel_list_manfaat.ajax.reload(null,false);        
            ...
            swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            ...
                            data        : {aksi:'Hapus', id_manfaat:id_manfaat},
                            dataType    : "JSON",
                            success     : function (data) {
