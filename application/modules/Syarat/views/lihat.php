    ...
    <div class="col-md-8">
        <div class="card shadow">
            <div class="card-body table-responsive">
                <table class="table table-bordered table-hover" style="border-collapse: collapse; border-spacing: 0; width: 100%;" id="tabel_syarat" width="100%" cellspacing="0">
                ...
                <div class="card-body d-flex justify-content-center">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label for="lob" class="col-form-label text-left">Syarat<span class="text-danger">*</span></label>
                            <div class="">
                                <textarea name="syarat" id="syarat" rows="5" class="form-control" placeholder="Masukkan Syarat" required data-parsley-required-message="Syarat harus terisi."></textarea>
                            </div>
                        </div> 
                        ...
                        <div class="form-group text-center mt-1 mb-0">
                            ...
                            <button type="button" class="btn btn-danger mt-1 batal_syarat" id="batal_syarat"><i class="fas fa-times mr-1"></i> Batal</button>
                        </div>   
...
<script>
    ...
    $(document).ready(function () {
        ...
        var tabel_list_syarat = $('#tabel_syarat').DataTable({
            "processing"        : true,
            "serverSide"        : true,
            "order"             : [],
            "ajax"              : {
                "url"   : "<?= base_url() ?>Syarat/tampil_data_syarat",
                "type"  : "POST",
                "data"  : function (data) {
                    data.read               = "<?= $role['read'] ?>";
        ...
        function tampil_premi() {
            ...
            $.ajax({
                url         : "<?= base_url() ?>Syarat/tampil_premi",
                method      : "POST",
        ...
        $('#batal_syarat').on('click', function () {
            reset_form();
        })
        ...
        $('#form_syarat').on('submit', function () {
            ...
            var form_syarat = $('#form_syarat').serialize();
            ...
            swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            url     : "<?= base_url() ?>Syarat/simpan_syarat",
                            type    : "POST",
                            beforeSend  : function () {
                                swal({
                                    title   : 'Menunggu',
                            ...
                            success : function (data) {
                                ...
                                tabel_list_syarat.ajax.reload(null,false);        
            ...
            swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            ...
                            data        : {aksi:'Hapus', id_syarat:id_syarat},
                            dataType    : "JSON",
                            success     : function (data) {
